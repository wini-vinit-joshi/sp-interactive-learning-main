...
export default function ArticleDetail({ params }: { params: { slug: string } }) {
  // In a real app, you'd fetch the article by slug. We use static dummy content here.
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative h-[400px] w-full bg-slate-900">
        ...
        <div className="container mx-auto max-w-3xl px-4 relative z-10 h-full flex flex-col justify-end pb-12">
          <Link href="/articles" className="inline-flex items-center text-blue-400 hover:text-blue-300 mb-6 font-medium text-sm transition-colors">

  ...
  return (
    <>
      ...
      {collapsed && <button
        ...
        style={{ bottom: "24px" }}
        className="fixed right-6 z-[9999] w-11 h-11 rounded-full bg-[#1a1a1a] text-white flex items-center justify-center hover:scale-105 active:scale-95 transition-transform el-btn-pulse"
      >
